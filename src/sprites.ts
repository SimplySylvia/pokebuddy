...
export async function getPokeSprite(
...
export async function checkPokegetInstalled(): Promise<boolean> {
  try {
...
export async function getInstallInstructions(): Promise<string> {
  const lines: string[] = [
